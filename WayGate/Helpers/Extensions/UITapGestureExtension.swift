...
//  WayGate
//
//  Created by Nabeel Nazir on 24/06/2023.
//
...
extension UITapGestureRecognizer {
    ...
    public func didTapAttributedString(_ string: String, in label: UILabel) -> Bool {
    ...
    private func didTapAttributedText(label: UILabel, inRange targetRange: NSRange) -> Bool {
        ...
        let characterTapped = layoutManager.characterIndex(for: locationOfTouchInTextContainer, in: textContainer, fractionOfDistanceBetweenInsertionPoints: nil) - 1
