...
#ifndef KIRIADVANCECAMERAKIT_SWIFT_H
#define KIRIADVANCECAMERAKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KiriAdvanceCameraKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20KiriAdvanceCameraKit34AVCapturePhotoCaptureProxyDelegate")
@interface AVCapturePhotoCaptureProxyDelegate : NSObject <AVCapturePhotoCaptureDelegate>
...
SWIFT_CLASS("_TtC20KiriAdvanceCameraKit12CaptureModel")
@interface CaptureModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC20KiriAdvanceCameraKit17ImageCaptureModel")
@interface ImageCaptureModel : CaptureModel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC20KiriAdvanceCameraKit24AdvanceImageCaptureModel")
@interface AdvanceImageCaptureModel : ImageCaptureModel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC20KiriAdvanceCameraKit11CaptureView")
